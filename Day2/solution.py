...
with open('input.txt') as file:
    ...
    for line in file: 
        ...
        cubes = line.split(':')[-1].replace(',', '').replace(';', '').replace('\n', '')

        numbers = [int(x) for x in cubes.split(' ') if x.isdigit()]
        letters = [x for x in cubes.split(' ') if x.isalpha()]
        ...
        for i in range(len(numbers)):
            max = dict_valid_maximum[letters[i]]
...
with open('input.txt') as file:
    ...
    for line in file: 
        ...
        for i in range(len(numbers)):
            ...
            if letters[i] not in dict_valid_maximum:
                dict_valid_maximum[letters[i]] = numbers[i]
            elif dict_valid_maximum[letters[i]] < numbers[i]:
                dict_valid_maximum[letters[i]] = numbers[i]
            else:
                pass

        total_amount.append(multiplyList(dict_valid_maximum.values()))
